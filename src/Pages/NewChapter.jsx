...
//     if (!formData.title || !formData.order || formData.pages.length === 0) {
...
//                 onChange={handleInputChange}
//                 className="mt-1 block w-full none px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-pink-500 focus:border-pink-500"
//                 required
//               />
//             </div>
