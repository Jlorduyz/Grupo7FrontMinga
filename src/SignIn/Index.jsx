      ...
      <div className="flex w-1/2 justify-center items-center bg-white">
        <div className="bg-white relative">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="border-2 border-solid border-gray-400 rounded-2xl px-3 py-2 pt-6">
                <div className="flex items-center justify-between">
                  <input
                    ...
                    className="pl-2 pr-8 outline-none border-2 border-green-500 w-full" />
            ...
            <button
              type="submit"
              className="block w-full h-12 bg-custom-pink mt-4 py-2 rounded-2xl text-white font-semibold mb-2 shadow-custom-yellow hover:bg-custom-pink-dark focus:ring-4 focus:ring-custom-yellow border-2 border-red-500"
