            ...
            <div className="flex w-1/2 justify-center items-center bg-white">
                <div className="bg-white relative">
                    <form onSubmit={handleSubmit}>
                        ...
                        <button
                            type="submit"
                            className="block w-full h-12 bg-custom-pink mt-4 py-2 rounded-2xl text-black font-semibold mb-2 shadow-custom-yellow hover:bg-custom-pink-dark focus:ring-4 focus:ring-custom-yellow border-2">Sign up</button>
